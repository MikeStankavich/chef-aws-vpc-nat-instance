...
default['aws-vpc-nat-instance']['monitoring']['install_dir'] = '/usr/local/bin'
default['aws-vpc-nat-instance']['monitoring']['user'] = 'root'
default['aws-vpc-nat-instance']['monitoring']['group'] = 'root'
